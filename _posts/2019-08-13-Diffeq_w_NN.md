...
["DGM: A deep learning algorithm for solving partial differential equations"](https://arxiv.org/pdf/1708.07469.pdf) and 
...
certain differential operator (maybe with respect to time or spacial coordinates) such as $\partial t + \laplace$. Our goal is find a ``nice" function $u$ well defined
on $\Omega$ that satisfies these equations at the same time. This task is *NOT* easy, work/research that has been continuing for centuries to develop
mature theotical and numerical methods to study the behavior of these equations as well as their possible solutions. If your major is with STEM
discipline, you certainly can not escape from this topic in your course work.
...
of differential equations can also be addressed as an optimization problem: 
 $$argmin_\limits_{\p} |||L \phi(p)|| + ||f(\phi; p)||$$  where $\phi$ is represented by a neural network and $||\cdot||$ is some norm or 
...
<img src = '/images/1d-sol.png' height="360" width="360">
<img src = '/images/1d-eqn-err.png' height="360" width="360">
